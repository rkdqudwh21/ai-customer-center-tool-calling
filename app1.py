...
mork_crm_db={
    ...
    "C-3003":{"name":"박지훈","level":"BASIC","recent_order_id":"ORD-5680"}
}

mock_knowledge_base={
    "환불":"VIP 고객은 구매 후 14일,일반 고객은 7일 이내에 환불 가능합니다.",
    "배송":"기본 배송 기간은 2-3일이며,주문 폭주 시 지연될수 있습니다.",
    "교환":"상품 수령 후 7일 이내 교환 신청이 가능합니다.",
    "고장":"제품 고장 문의는 상담 티켓을 생성하여 담당자가 확인합니다."
}
